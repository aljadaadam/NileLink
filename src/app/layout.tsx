...
export const metadata: Metadata = {
  ...
  description:
    "The #1 SaaS platform to manage MikroTik hotspot networks. Easiest MikroTik setup — generate WiFi vouchers, create packages, control users, and monitor routers from one dashboard. Full reseller system included.",
  keywords: [
    "MikroTik",
    "hotspot management",
    "WiFi management",
    ...
    "MikroTik SaaS",
    "hotspot server",
    "MikroTik cloud management",
    "WiFi reseller system",
    "MikroTik API",
    "hotspot login page",
    "إدارة شبكات واي فاي",
    "أكواد واي فاي",
    ...
    "إدارة مايكروتيك",
    "سيرفر هوتسبوت",
    "نظام كوبونات واي فاي",
    "لوحة تحكم مايكروتك",
    "صفحة دخول هوت سبوت",
    "نظام وكلاء إنترنت",
    "إدارة راوتر مايكروتك",
    "NileLink SaaS",
  ],
